    ...
    <nav className="fixed top-0 z-50 w-full border-b border-border/60 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          <a href="#" className="hidden text-sm font-medium text-muted-foreground transition-colors hover:text-foreground sm:block">Sign in</a>
          <button className="rounded-md bg-foreground px-3 py-1.5 text-sm font-semibold text-background transition-all hover:bg-white">
            Get Started
          </button>
        </div>
      </div>
